    ...
    const places = await Promise.all([
      prisma.place.create({
        data: {
          ...
          images: JSON.stringify(['https://images.unsplash.com/photo-1580418827493-f2b22c0a76cb?w=800&q=80']),
          latitude: 24.4672,
          longitude: 39.6111,
        },
      }),
      prisma.place.create({
        data: {
          ...
          images: JSON.stringify(['https://images.unsplash.com/photo-1564769625905-50e93615e769?w=800&q=80']),
          latitude: 24.4393,
          longitude: 39.6206,
        },
      }),
      ...
      prisma.place.create({
        data: {
          ...
          images: JSON.stringify(['https://images.unsplash.com/photo-1565099824688-e93eb20fe622?w=800&q=80']),
          latitude: 24.4747,
          longitude: 39.5834,
        },
      }),
      ...
      prisma.place.create({
        data: {
          ...
          crowdLevel: 'medium',
          currentEvents: JSON.stringify([]),
          images: JSON.stringify(['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&q=80']),
          latitude: 24.4589,
          longitude: 39.6091,
        },
      }),
      prisma.place.create({
        data: {
          ...
          images: JSON.stringify(['https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80&auto=format&fit=crop']),
          latitude: 24.4912,
          longitude: 39.5586,
        },
      }),
      prisma.place.create({
        data: {
          ...
          crowdLevel: 'low',
          currentEvents: JSON.stringify([]),
          images: JSON.stringify(['https://images.unsplash.com/photo-1604881991720-f91add269bed?w=800&q=80']),
          latitude: 24.4456,
          longitude: 39.5836,
        },
      }),
