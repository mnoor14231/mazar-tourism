  ...
  const places = await Promise.all([
    prisma.place.create({
      data: {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1591604021695-0c69b7c05981?w=800']) as string,
        latitude: 24.4672,
        longitude: 39.6111,
      },
    }),
    prisma.place.create({
      data: {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1564769610854-034c0e4f41f5?w=800']) as string,
        latitude: 24.4393,
        longitude: 39.6206,
      },
    }),
    prisma.place.create({
      data: {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1551918120-9739cb430c6d?w=800']) as string,
        latitude: 24.5109,
        longitude: 39.6217,
      },
    }),
    prisma.place.create({
      data: {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1565789433644-46c5b4411f9f?w=800']) as string,
        latitude: 24.4747,
        longitude: 39.5834,
      },
    }),
    ...
    prisma.place.create({
      data: {
        ...
        crowdLevel: 'medium',
        currentEvents: JSON.stringify([]) as string,
        images: JSON.stringify(['https://images.unsplash.com/photo-1553177607-4e3c55c12dae?w=800']) as string,
        latitude: 24.4589,
        longitude: 39.6091,
      },
    }),
    prisma.place.create({
      data: {
        ...
        images: JSON.stringify(['https://images.unsplash.com/photo-1571655790646-5fccf0f1d78d?w=800']) as string,
        latitude: 24.4912,
        longitude: 39.5586,
      },
    }),
    prisma.place.create({
      data: {
        ...
        crowdLevel: 'low',
        currentEvents: JSON.stringify([]) as string,
        images: JSON.stringify(['https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=800']) as string,
        latitude: 24.4456,
        longitude: 39.5836,
      },
    }),
